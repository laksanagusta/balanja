...
func (s *Service) List(ctx context.Context, identity database.Identity, includeArchived bool) (items []Unit, err error) {
...
func (s *Service) Create(ctx context.Context, identity database.Identity, input WriteInput) (value Unit, err error) {
...
func (s *Service) Rename(ctx context.Context, identity database.Identity, id uuid.UUID, input WriteInput) (value Unit, err error) {
	if id == uuid.Nil {
...
func (s *Service) Archive(ctx context.Context, identity database.Identity, id uuid.UUID) (value Unit, err error) {
	if id == uuid.Nil {
		return Unit{}, ErrNotFound
	}
	err = s.runner.Run(ctx, identity, func(tx database.Tx) error {
...
func (s *Service) Restore(ctx context.Context, identity database.Identity, id uuid.UUID) (value Unit, err error) {
	if id == uuid.Nil {
		return Unit{}, ErrNotFound
	}
	err = s.runner.Run(ctx, identity, func(tx database.Tx) error {
