  ...
  return (
    <div>
      ...
      <div className="rounded-panel border border-border bg-surface p-4">
        <p className="mb-3 text-sm text-text-muted">Overlay dialogs for confirmations, item details, and payment.</p>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md rounded-panel border border-border bg-surface p-6 shadow-panel">
              <div className="mb-5 flex items-center justify-between">
                <h4 className="text-lg font-semibold text-text">Item details</h4>
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button variant="primary" onClick={() => setOpen(false)}>Add to order</Button>
              </div>
            </div>
          </div>
        )}
        ...
        {confirmOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm rounded-panel border border-border bg-surface p-6 shadow-panel text-center">
              ...
              <h4 className="mb-2 text-lg font-semibold text-text">Void this order?</h4>
